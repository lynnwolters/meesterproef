...
<div class="spotlight two"></div>
    ...
    <!-- truss svg -->
    <svg class="truss-1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    ...
    <svg class="truss-2" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 1165.79 356.68" style="enable-background:new 0 0 1165.79 356.68;" xml:space="preserve">
        <g id="bovenkant">
            <g>
                <polygon class="st0" points="1153.78,331.73 1148.9,336.06 9.91,33.13 14.8,28.81 		"/>
    ...
    <ul class="list">
        ...
        while ($blogposts->have_posts()) {
            ...
            if ($thumbnail_url) {
                ...
                <li class="item">
                    <button>
                        <img src="<?php echo esc_url($thumbnail_url); ?>" alt="<?php echo esc_attr($alt_text); ?>" loading="lazy">
                    </button>
